...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} is going to Enjoy real world".format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} is back to virtual world".format(update.effective_user.first_name))
