...
from IHbot.modules.helper_funcs.chat_status import is_user_admin, user_admin, can_restrict
from IHbot.modules.log_channel import loggable
from IHbot.modules.sql import antiflood_sql as sql
...
def check_flood(bot: Bot, update: Update) -> str:
    ...
    try:
        ...
        msg.reply_text("I did not ask for your trust. I demand only your obedience.But you, you were just a "
